...
3. input_shape
  ...
  - 만약에 지정해 주려면 합성곱 층 하단에 올라가야 하므로, (224, 224, 3)이  
    되어야 함  
...
- 특히 입력층 쪽 Dense 층은 랜덤하게 초기화 되었기 때문에  
